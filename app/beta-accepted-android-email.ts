...
// HTML beta-accepted email for Android testers. Sent to applicants who
// got in: Google Play closed-testing opt-in instructions, what we're
// actually testing (usability, not content), and a hard nudge to use the
// in-app "?" button for every bug / wrong-content report. Mirrors the
// cream + coral palette and dark-mode lockout used by the other beta
// emails.
export function buildBetaAcceptedAndroidEmail() {
  const coral = "#EC6144";
  ...
  // Google Play internal-test opt-in URL. This is the internal-testing
  // track link (not the closed-test/package-id format); double-check
  // before each send in case the track is swapped.
  const optInUrl =
    "https://play.google.com/apps/internaltest/4701622289151171620";
  const playStoreUrl =
    "https://play.google.com/store/apps/details?id=com.darsapp.app";
      ...
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%;">
        ...
        <tr>
          <td class="dm-bg-coral-soft" style="background:${coralSoft}; border-radius:24px; padding:44px 24px 40px; text-align:center;">
            <p class="dm-text-coral" style="margin:0 0 10px; font-family:${sans}; font-size:11px; letter-spacing:0.18em; text-transform:uppercase; color:${coralDeep}; font-weight:600;">Beta access &middot; Android</p>
            ...
            <p class="dm-text-ink-soft" style="margin:0; font-family:${sans}; font-size:14.5px; line-height:1.5; color:${inkSoft};">
              Mubarak &mdash; consider this your invite to the Play Store closed test.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:0 4px 8px;">
            ...
            <p class="dm-text-ink-soft" style="margin:0 0 22px; font-family:${sans}; font-size:15px; line-height:1.7; color:${inkSoft};">
              Below is everything you need to install Dars on your Android phone and start poking at it. It takes about a minute.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td class="dm-bg-coral" style="background:${coral}; border-radius:20px; padding:34px 32px; text-align:center;">
            <p class="dm-text-white" style="margin:0 0 8px; font-family:${sans}; font-size:11px; letter-spacing:0.14em; text-transform:uppercase; color:#ffffff; font-weight:600; opacity:0.85;">↳ Install for Android</p>
            <p class="dm-text-white" style="margin:0 0 22px; font-family:${sans}; font-size:22px; line-height:1.3; font-weight:500; letter-spacing:-0.01em; color:#ffffff;">
              Join the <span style="font-family:${serif}; font-style:italic; font-weight:400;">testing track.</span>
            </p>
            <a href="${optInUrl}" class="dm-bg-card dm-text-coral" style="display:inline-block; text-decoration:none; background:${card}; color:${coral}; padding:14px 30px; border-radius:999px; font-family:${sans}; font-size:15px; font-weight:600;">
              <span class="dm-text-coral" style="color:${coral};">Join the Dars test on Play Store &rarr;</span>
            </a>
          </td>
        </tr>
        ...
        <tr>
          <td class="dm-bg-card dm-border" style="background:${card}; border:1px solid ${border}; border-radius:18px; padding:24px 22px 6px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
              ${step(
                1,
                "Sign into Play Store with the right email.",
                "Use the same Google account you applied with &mdash; that&#39;s the one we&#39;ve added to the tester list. Wrong account = the link won&#39;t work.",
              )}
              ${step(
                2,
                "Tap the button above on your Android phone.",
                "It opens the Dars closed-test page. Hit <em>Become a tester</em> (or <em>Join</em>) to opt in.",
              )}
              ${step(
                3,
                "Open Dars on the Play Store.",
                `Once you&#39;ve joined, you can install Dars normally &mdash; <a href="${playStoreUrl}" class="dm-text-coral" style="color:${coral};">tap here</a> or search &ldquo;Dars&rdquo; on the Play Store. You&#39;ll see &ldquo;You&#39;re a tester&rdquo; on the listing.`,
              )}
              ${step(
                4,
        ...
        <tr>
          <td style="padding:0 4px;">
            <p class="dm-text-ink-subtle" style="margin:0; font-family:${sans}; font-size:13px; line-height:1.6; color:${inkSubtle};">
              <em>Heads up:</em> it can take Play Store up to 15 minutes after opting in to recognise you as a tester. If you don&#39;t see Dars yet, give it a few minutes and try again.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td class="dm-bg-coral-soft dm-border" style="background:${coralSoft}; border:1px solid ${border}; border-radius:18px; padding:22px 24px;">
            ...
            <p class="dm-text-ink-soft" style="margin:0; font-family:${sans}; font-size:14.5px; line-height:1.65; color:${inkSoft};">
              If you were testing an earlier build, update Dars to the newest one on the Play Store first, or uninstall it and install it again after opting in above. Then open it and create your account again: we&#39;ve switched sign-in providers, so the login you made on an earlier build won&#39;t get you back in.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:0 4px 14px;">
            ...
            <p class="dm-text-ink-soft" style="margin:0 0 14px; font-family:${sans}; font-size:15px; line-height:1.7; color:${inkSoft};">
              There&#39;s also only <strong class="dm-text-ink" style="color:${ink}; font-weight:600;">a few books and a handful of chapters</strong> loaded for now &mdash; just enough to put the app through its paces. That&#39;s deliberate. Once the beta wraps, we&#39;ll start adding books and chapters properly. So please <em>don&#39;t</em> write in asking when more books are coming or why your favourite one isn&#39;t here yet &mdash; it is coming, just not during the test. Right now we only need eyes on what&#39;s already in.
            </p>
            <p class="dm-text-ink-soft" style="margin:0; font-family:${sans}; font-size:15px; line-height:1.7; color:${inkSoft};">
              What we actually want you to break: <strong class="dm-text-ink" style="color:${ink}; font-weight:600;">the app itself.</strong> The flow. The feel. The buttons that don&#39;t do what you&#39;d expect, the screens that look wrong on your Android, the moments where you go &ldquo;wait &mdash; what is this supposed to do?&rdquo;
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td>
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
              ${bullet(
                "Bugs and crashes.",
                "Anything that freezes, force-closes, or behaves in a way that clearly wasn&#39;t intended.",
              )}
              ${bullet(
                "Confusing flows.",
              ...
              ${bullet(
                "Visual oddities.",
                "Text overlapping, weird spacing, cut-off buttons, things that look broken on your specific Android device (Android is wildly diverse &mdash; we need eyes on it).",
              )}
              ${bullet(
                "Performance.",
        ...
        <tr>
          <td style="padding:0 4px;">
            ...
            <p class="dm-text-ink-subtle" style="margin:0; font-family:${sans}; font-size:12px; line-height:1.55; color:${inkSubtle};">
              You&#39;re getting this because you applied for the Dars beta and your Android application was accepted.<br>
