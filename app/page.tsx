        ...
        <div className="relative  mx-auto px-6">
          ...
          <div className="mt-5 flex items-center justify-center gap-2.5">
            <a
              ...
              className="w-10 h-10 grid place-items-center rounded-[13px] transition-transform hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
            >
              {/* the mask lives on the inner span so the focus ring on the
                  anchor isn't clipped away with it */}
              <span
                className="squircle w-full h-full grid place-items-center text-white"
                style={{
                  background:
            ...
            <a
              ...
              className="group w-10 h-10 grid place-items-center rounded-[13px] transition-transform hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
            >
              <span className="squircle w-full h-full grid place-items-center bg-ink text-white transition-colors group-hover:bg-ink-soft">
                {/* viewBox nudged so the note sits dead-centre in the squircle:
                    its own bbox centre is 11.31, 12.44, not 12, 12 */}
                <svg
                  width="15"
                  height="15"
                  viewBox="-0.69 0.44 24 24"
                  fill="currentColor"
                  aria-hidden="true"
                >
        ...
        <div className="w-full max-w-5xl mx-auto bg-card/90 backdrop-blur-xl border border-border rounded-3xl shadow-card px-6 py-7 flex flex-col items-center gap-5 text-center">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="w-9 h-9 grid place-items-center rounded-[12px] transition-transform hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
            >
              <span
                className="squircle w-full h-full grid place-items-center text-white"
                style={{
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="TikTok"
              className="group w-9 h-9 grid place-items-center rounded-[12px] transition-transform hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
            >
              <span className="squircle w-full h-full grid place-items-center bg-ink text-cream-100 transition-colors group-hover:bg-ink-soft">
                <svg width="14" height="14" viewBox="-0.69 0.44 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M19.321 5.562a5.124 5.124 0 0 1-.443-.258 6.228 6.228 0 0 1-1.137-.966c-.849-.971-1.166-1.956-1.282-2.645h.004c-.097-.573-.057-.943-.05-.943h-3.865v14.943c0 .2 0 .399-.008.595a4.521 4.521 0 0 1-.072.65 4.408 4.408 0 0 1-.7 1.66 4.4 4.4 0 0 1-3.69 2.107c-2.434 0-4.41-1.99-4.41-4.444s1.976-4.444 4.41-4.444c.461 0 .904.072 1.32.204l.005-3.94a8.353 8.353 0 0 0-1.336-.108c-4.621 0-8.366 3.776-8.366 8.43 0 2.857 1.41 5.385 3.566 6.918A8.302 8.302 0 0 0 8.272 24c4.622 0 8.367-3.776 8.367-8.43V7.842a10.473 10.473 0 0 0 6.272 2.034V5.954a4.395 4.395 0 0 1-3.59-.392z" />
                </svg>
              </span>
            </a>
